...
# Load the data. 
file = "C:/Users/moe/Downloads/archive/wineQualityReds.csv"
...
#answer theyre all infact discrete values
...
#lighter color means more positive corr while darker color means negat corr and in between is 0 no corr
#it shows us some interesting correlations such as that the density and fixed acidity have the highest positive corr
...
X = data.drop(["fixed.acidity", "quality"],axis=1)
